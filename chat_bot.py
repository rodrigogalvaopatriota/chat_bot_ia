...
class Oracle:
    ...
    def streamlit(self):
        ...
        st.write("Olá, sou assistente virtual dos indicadores: Produtividade, repetido, garantia.Possuo também telefones e emails de colaboradores(por enquanto possuo somente os dados dos coordenadores de campo do PR). Como posso ajudar você hoje?")
